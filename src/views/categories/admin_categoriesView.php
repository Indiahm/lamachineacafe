...
<a href="<?= $router->generate('addCategories'); ?>" class="btn btn-success mb-4">Ajouter une Categories</a>
    ...
    <?php foreach ($categories as $categorie) { ?>
            <tr>
                ...
                <td class="table-secondary text-center align-middle">
                    ...
                    <a href="<?= $router->generate('deleteCategories', ['id' =>  $categorie->id]); ?>" class="btn btn-danger btn-sm mr-2">
                        Supprimer
                    </a>
                </td>
            </tr>

...
<head>
    ...
    <title>Politique de Confidentialité - La Machine à Café</title>
...
<body>
    ...
    <h1 class="title">Politique de Confidentialité</h1>
        <section>
            ...
            <p>L’adresse de notre site est : <a href="https://kafe-etxea.com">https://lamachineacafe.test/accueil</a>.</p>
        </section>
        ...
        <section>
            ...
            <p>Une chaîne anonymisée créée à partir de votre adresse e-mail (également appelée hash) peut être envoyée au service Gravatar pour vérifier si vous utilisez ce dernier. Les clauses de confidentialité du service Gravatar sont disponibles sur leur <a href="https://automattic.com/privacy/">site web</a>. Après validation de votre commentaire, votre photo de profil sera visible publiquement à côté de votre commentaire.</p>
        </section>
    ...
    <div class="maj">
        <p>Mis à jour le 4 juillet 2024.</p>
    </div>
</body>
